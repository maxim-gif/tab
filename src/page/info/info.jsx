    ...
    <div className="info">
      {statusVictoryElement && <div className="conditionsVictory">
        ...
        <div className="conditions">
          ...
          <p>1. Побеждает игрок, набравший самое большое количество очков за убитых боссов локаций (зодиаков). Боссы приносят очки по такой схеме: босс первой локации - 1 очко, босс второй локации - 1 очко, босс третьей локации - 2 очка, босс четвертой локации - 2 очка, финальный босс - 2 очка. После первого прохождения игры, игроки могут перейти на возвышения, в таком случае убийство каждого босса будет приносить на 0.5 очка больше, при переходе на следующее возвышение, ещё на 0.5 очка и т.д.  Если игрок начал драться с боссом до окончания таймера ивента, можно продолжить с ним драться, т.к. боссы являются главным фактором победы.</p>
          <p>2. Игра проходит на нулевом сейве с DLC. Игроки без опыта, персонажи из DLC разрешены. Рестарт забега разрешен после прохождения первых двух боевых локаций (битва или исследование).</p>
          <p>3. В Мастере Игорей по рогаликам стример НЕ БУДЕТ мешать игрокам в прохождении забегов. За стримера игрокам мешает чат проклятиями! (и пополняет призовой фонд)
          Для того, чтобы помешать лидеру, Ведущий может объявить, что следующие несколько (от 5 до бесконечности) личных проклятий прокрученных в колесе попадают только в лидера или не действуют на отстающего игрока.
          </p>
